...
def main():
    ...
    parser.add_argument("--data_root", type=str, default="/mnt/disk/shengzhixuan/project/HunyuanWorld-1.0/data/InteriorGS", help="Input dataset root")
    parser.add_argument("--output_root", type=str, default="/mnt/disk/shengzhixuan/project/HunyuanWorld-1.0/data/CG-DATA-InteriorGS", help="Output root")
